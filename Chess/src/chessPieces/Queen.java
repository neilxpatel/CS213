...
/**
* class for Queen that extends Piece
* @author Yash Patel
* @author Neil Patel
*/
public class Queen extends Piece{
	...
	public Queen(String pieceName, int currRow, int currCol) {
		super(pieceName, currRow, currCol);
	}
	
	/**
	 * This method checks if the move that we are going to make for the current location 
	 * to the destination is legal according to how a Queen can move
	 ...
	 * @return checks if the move is valid for the Queen
	 */
	public boolean isValidMove(int destRow, int destCol) {
		...
		if((xDistance == yDistance) || (xDistance == 0 && yDistance != 0) || (xDistance != 0 && yDistance == 0)) {
